    ...
    <div>
      ...
      <div className="flex flex-col gap-6 px-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[#777777]">Enter your information to create account</p>
        </div>
        ...
        <form className="flex flex-col gap-3">
          ...
          <p className="text-sm text-[#232323] text-center cursor-pointer">Already have an account? <Link href="/login" className="text-[#6784F6] underline">Login</Link></p>
        </form>
      </div>
    </div>
  );
