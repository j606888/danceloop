    ...
    <div className="min-h-screen flex flex-col">
      <div className="bg-gray-100 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-3xl font-bold text-gray-900">Privacy Policy for Danceloop</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Danceloop.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to Danceloop, accessible from <a href="danceloop.vercel.app" rel="external nofollow noopener" target="_blank">danceloop.vercel.app</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email: j606888@gmail.com</p>
              </li>
              <li>
                <p>By phone number: 0968313044</p>
              </li>
            </ul>
          </div>
        </div>
