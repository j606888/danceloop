        ...
        <div className="flex flex-col gap-3">
          {PRIVACY_OPTIONS.map((option) => (
            <div
              ...
              className={`px-4 py-4 border-1  rounded-md flex items-center gap-3 cursor-pointer ${visibility === option.value ? "bg-[#6784F6]/5 border-[#6784F6]" : "border-[#E5E5E5]"}`}
            >
              <div className={`w-4.5 h-4.5 bg-white rounded-full ${visibility === option.value ? "border-5 border-[#6784F6]" : "border-1 border-[#D5D5D5]"}`} />
